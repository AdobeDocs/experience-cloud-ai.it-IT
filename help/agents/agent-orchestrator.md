...
| --- | --- | --- |
| [Adobe Marketing Agent per [!DNL Microsoft 365 Copilot]](ama-ms.md) | Recupera istantaneamente le informazioni di marketing da Adobe Experience Platform in [!DNL Microsoft 365] app come [!DNL Teams], [!DNL Word], [!DNL Powerpoint] e [!DNL Excel]. Con questo agente, puoi mantenere la cronologia delle chat tra le app e continuare senza interruzioni la conversazione mentre lavori. | |
